...
function counter(value) {
 secondsLeft  --
  ...
  if (secondsLeft < 20) { 
    timerEl.style.color = "red"; // if seconds left is less than 20, the timer will turn red to alert the user the timer is running out
  }
...
function answerFunc(marryPoppins) {
  ...
  if (marryPoppins !== questions[questionArr].correctAnswer) {
    secondsLeft -= 10; // deducting time each incorrect answer
...
var initBtn = function () {
  // adding a function onto my submit button
